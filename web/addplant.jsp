<%-- 
    Document   : addplant
    Created on : Mar 7, 2023, 7:14:45 PM
    Author     : Admin
--%>
    ...
    <body>
        ...
        <form action="MainController" method="post" class="">
            ...
            <table>
                ...
                <tr>
                    <td>Category: </td>
                    <td><select name="txtcategory" required="">
                            <p:forEach var="cate" items="${ requestScope.CateList }">
                ...
                <tr>
                    <td></td>
                    <td><button type="submit" value="AddPlant" name="action">Add</button></td>
                </tr>
            </table>
        </form>
    </body>
